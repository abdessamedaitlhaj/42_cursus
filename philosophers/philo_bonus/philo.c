...
/*   Updated: 2024/10/04 01:06:56 by aait-lha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	long	now_time;
	now_time = get_time() - philo->args->start_time;
...
void	*monitor(void *data)
{
	...
	while (1)
	{
		if (philo->args->nb_meals != -1 && philo->eat_count >= \
			philo->args->nb_meals || \
			philo->args->time_to_die < get_time() - philo->last_eat)
		{
